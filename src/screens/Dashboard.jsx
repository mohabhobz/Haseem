  ...
  return (
    <AppShell>
      ...
      <div className="row2">
        ...
        <Panel title="محتاج تصرّف منك" action={<span className="ob-dots" aria-hidden="true"><Ico.more size={18} /></span>}>
          <div className="needs">
            {NEEDS.map((n) => (
      ...
      <div className="row3">
        ...
        <Panel title="آخر المستندات" action={<span className="ob-dots" aria-hidden="true"><Ico.more size={18} /></span>}>
